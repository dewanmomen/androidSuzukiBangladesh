            ...
            if( status == true)
            {
               ...
               /* View space1 = new View(this);
                ...
                for (int i = 0; i <Engine.length() ; i++)
                {
                    ...
                    engine_Title_TextView.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.FILL_PARENT, TableRow.LayoutParams.WRAP_CONTENT));
                    TextView engine_Value_TextView=new TextView(context);
                    engine_Value_TextView.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.FILL_PARENT, TableRow.LayoutParams.WRAP_CONTENT));
                    ...
                    if((i%2)==0)
                    {
                        ...
                        //engine_Title_TextView.setBackgroundColor(getResources().getColor(R.color.blue_grey_500));//"#d8d8d8"
                        engine_Value_TextView.setBackgroundColor(getResources().getColor(R.color.common_google_signin_btn_text_dark_default));
                   ...
                   /* if((i%2)==0)
                    ...
                    tableLayout.addView(row_engine,new TableLayout.LayoutParams(TableLayout.LayoutParams.FILL_PARENT, TableLayout.LayoutParams.WRAP_CONTENT));
